...
<template>
  <section class="ordo-queue-card">
    <div class="ordo-queue-card__header"><div><p class="ordo-kicker">Fila administrativa</p><h2>Regras de vida</h2><span>Somente regras públicas · mais antigas primeiro</span></div><span class="ordo-queue-card__count">{{ formatNumber(pagination?.total) }}</span></div>
