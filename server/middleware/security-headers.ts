...
export default defineEventHandler((event) => {
  ...
  const cspDirectives = [
    "default-src 'self'",
    "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://maps.googleapis.com https://maps.gstatic.com https://www.google.com https://www.gstatic.com https://fonts.googleapis.com https://www.instagram.com https://www.googletagmanager.com",
